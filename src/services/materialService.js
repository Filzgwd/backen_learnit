...
exports.createMaterial = async (data) => {
  ...
  try {
    ...
    console.error(`[createMaterial] ERROR storing contents:`, contentError.message);
    console.error(`[createMaterial] Error details:`, {
      code: contentError.code,
      detail: contentError.detail,
      stack: contentError.stack
    });
    throw contentError; // Re-throw to fail the entire request
  }
